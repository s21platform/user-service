...
func (m *MockDbRepo) GetPostsByIds(arg0 context.Context, arg1 []string) (*model.PostInfoList, error) {
	m.ctrl.T.Helper()
...
func (mr *MockDbRepoMockRecorder) GetPostsByIds(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetPostsByIds", reflect.TypeOf((*MockDbRepo)(nil).GetPostsByIds), arg0, arg1)
}
...
// ProduceMessage indicates an expected call of ProduceMessage.
func (mr *MockUserPostCreatedProduserMockRecorder) ProduceMessage(ctx, message, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
