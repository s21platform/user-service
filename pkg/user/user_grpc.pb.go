...
func (c *userServiceClient) CheckFriendship(ctx context.Context, in *CheckFriendshipIn, opts ...grpc.CallOption) (*CheckFriendshipOut, error) {
	...
	err := c.cc.Invoke(ctx, "/UserService/CheckFriendship", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) GetPostsByIds(ctx context.Context, in *GetPostsByIdsIn, opts ...grpc.CallOption) (*GetPostsByIdsOut, error) {
	out := new(GetPostsByIdsOut)
	err := c.cc.Invoke(ctx, "/UserService/GetPostsByIds", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServiceServer) GetPostsByIds(context.Context, *GetPostsByIdsIn) (*GetPostsByIdsOut, error) {
...
func _UserService_CheckFriendship_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/CheckFriendship",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _UserService_CreatePost_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreatePost(ctx, req.(*CreatePostIn))
	}
	return interceptor(ctx, in, info, handler)
}

func _UserService_GetPostsByIds_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetPostsByIdsIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).GetPostsByIds(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/UserService/GetPostsByIds",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetPostsByIds(ctx, req.(*GetPostsByIdsIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_GetPostsByIds_Handler,
		},
	},
