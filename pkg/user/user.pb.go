...
const file_api_user_proto_rawDesc = "" +
	...
	"\tpost_uuid\x18\x01 \x01(\tR\bpostUuid\"1\n" +
	...
	"\apost_id\x18\x02 \x01(\tR\x06postId2\xf5\x06\n" +
	"\vUserService\x129\n" +
	...
	"\n" +
	"CreatePost\x12\r.CreatePostIn\x1a\x0e.CreatePostOut\"\x00B\n" +
